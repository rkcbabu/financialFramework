...
public class CCardFormDialog extends javax.swing.JDialog {

    private RegistrationActionListener listener;

    public CCardFormDialog(RegistrationActionListener listener) {
    ...
    void JButtonOK_actionPerformed(java.awt.event.ActionEvent event) {
        try {
            CCardFormModel crForm = new CCardFormModel();
